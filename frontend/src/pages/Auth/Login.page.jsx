...
const LoginPage = () => {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-ghost ">
      <ToastContainer/>
      <div className="w-full md:w-1/3 bg-white h-screen md:h-[60%] rounded-2xl px-8 py-10">
        <div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} action="" className="flex flex-col gap-y-2 mt-4">
          {/* email */}
          <div>
            <fieldset className="fieldset">
              ...
              <label className="input validator w-full bg-gray-300 text-black rounded-xl ">
                <svg
                ...
                <input {...register("email")} type="email" placeholder="mailinfity.com" required />
              </label>
          ...
          <div>
            <fieldset className="fieldset ">
              ...
              <div>
                <label className="input validator bg-gray-300 text-black w-full rounded-xl">
                  <svg
                    className="h-[1em] opacity-50"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
        ...
        <div className="flex justify-center items-center mt-4">
          <p className="text-black text-[15px]">Don't have an account?</p>
          <NavLink
            to="/auth/signup"
            className="text-primary text-[15px] font-medium ml-2"
          >
            Sign Up
          </NavLink>
          </div>
